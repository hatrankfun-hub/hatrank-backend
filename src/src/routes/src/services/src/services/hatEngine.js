const HATS = [
  { level:1, emoji:'🎩', title:'PHANTOM HAT',  min:0,  max:15  },
  { level:2, emoji:'🧢', title:'ROOKIE CAP',   min:16, max:32  },
  { level:3, emoji:'👒', title:'STRAW HAT',    min:33, max:50  },
  { level:4, emoji:'🪖', title:'FIELD HAT',    min:51, max:68  },
  { level:5, emoji:'🎓', title:'SCHOLAR HAT',  min:69, max:84  },
  { level:6, emoji:'👑', title:'CROWN HAT',    min:85, max:100 },
];
